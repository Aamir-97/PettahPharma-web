...
function VisitTypes() {
  ...
  useEffect(() => {
    const fetchData = async () => {
        const response = await axios.get('http://localhost:3001/reppromotionVisitCount', {
            params: {
  ...
  useEffect(() => {
    const fetchData = async () => {
        const response = await axios.get('http://localhost:3001/repgeneralVisitCount', {
            params: {
                manager_ID: manager_ID,
            }
        });
  ...
  useEffect(() => {
    const fetchData = async () => {
        const response = await axios.get('http://localhost:3001/repfeedbackVisitCount', {
            params: {
                manager_ID: manager_ID,
            }
        });
